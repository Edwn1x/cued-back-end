...
MIGRATIONS = [
    ...
    "ALTER TABLE users ADD COLUMN IF NOT EXISTS card_setup_at TIMESTAMP",
    "ALTER TABLE users ADD COLUMN IF NOT EXISTS card_opened_at TIMESTAMP",
    "ALTER TABLE users ADD COLUMN IF NOT EXISTS card_explained_at TIMESTAMP",
